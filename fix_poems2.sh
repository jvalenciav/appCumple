...
class _PoemsScreenState extends State<PoemsScreen>
  ...
  // Total de paginas: poemas + pagina especial
  int get _totalPages => _poems.length + 1;
  ...
  Widget _buildCodeLine(String line) {
    ...
    if (line.startsWith('//') || line.startsWith('  //')) {
      textColor = const Color(0xFF6A9955);
      ...
      textColor = const Color(0xFFCE9178);
