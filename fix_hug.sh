#!/bin/bash
# ================================================================
# AGREGAR: Pantalla "Abrazo Virtual" con personajes chibi
# Ejecuta desde la raiz de cynthia_app/: bash fix_hug.sh
# ================================================================

echo "Creando pantalla Abrazo Virtual..."

mkdir -p lib/features/hug

cat > lib/features/hug/hug_screen.dart << 'ENDOFFILE'
import 'dart:math';
...
class _ChibiCynthiaPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Pelo largo (oscuro con reflejos)
...
echo "  Creado: lib/features/hug/hug_screen.dart"

# Agregar import y seccion al home
sed -i '' "s|import '../effort/effort_screen.dart';|import '../effort/effort_screen.dart';\nimport '../hug/hug_screen.dart';|" lib/features/home/home_screen.dart 2>/dev/null || sed -i "s|import '../effort/effort_screen.dart';|import '../effort/effort_screen.dart';\nimport '../hug/hug_screen.dart';|" lib/features/home/home_screen.dart

sed -i '' "s|screen: const EffortScreen(),|screen: const EffortScreen(),\n    ),\n    _SectionData(\n      title: 'Abrazo Virtual',\n      subtitle: 'Juntanos con un toque',\n      icon: Icons.people_rounded,\n      color: AppColors.roseGold,\n      screen: const HugScreen(),|" lib/features/home/home_screen.dart 2>/dev/null || sed -i "s|screen: const EffortScreen(),|screen: const EffortScreen(),\n    ),\n    _SectionData(\n      title: 'Abrazo Virtual',\n      subtitle: 'Juntanos con un toque',\n      icon: Icons.people_rounded,\n      color: AppColors.roseGold,\n      screen: const HugScreen(),|" lib/features/home/home_screen.dart
